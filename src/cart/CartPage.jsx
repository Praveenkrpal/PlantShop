...
// const CartPage = () => {
//   // Initialize cart items with state (prices converted to INR)
...
//   // Calculate totals dynamically in INR
//   const subtotal = cartItems.reduce(
//     (sum, item) => sum + item.price * item.quantity,
//     0
//   );
//   const tax = subtotal * 0.18; // 18% GST (common in India)
//   const total = subtotal + tax;

//   // Format currency for Indian display
...
//     // Just replace the state management parts with the Redux versions
//     <div className="max-w-6xl mx-auto px-4 py-8">
//       //{" "}
//       <h1 className="text-3xl font-bold text-center mb-8 text-green-700">
//         // Your Cart //{" "}
