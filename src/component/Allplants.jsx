...
//     // You can replace this with your own cart handling logic
//     // For now, it just shows an alert
//     alert(`Added ${plant.name} to cart!`);

//     // If you're using context or state for cart, you would update it here
...
//     },
//     // Add the remaining 52 plants here
//     // ...
//   ];
...
// -----------above code use only static data--------------------
...
// // Only for development - REMOVE BEFORE DEPLOYING TO PRODUCTION
// const UNSPLASH_ACCESS_KEY = "lJNvj-GuGvL97q-D11jJjekJpsugAO2nO838fdiv-Qo";
...
//         `https://api.unsplash.com/search/photos?query=potted+${encodeURIComponent(
//           plantName
//         )}&page=1&per_page=1&orientation=squarish`,
//         {
//           headers: {
...
//     } catch (err) {
//       console.error("Error fetching plant image:", err);
//       return null;
//     }
//   };
...
//         // First fetch your plant data (using your original data for now)
//         const plantsData = [
//           // Your original plant data array here (from your first message)
//           // I'm showing just a few for example:
//           {
//             id: 1,
//             name: "Snake Plant",
//             specificName: "Sansevieria Trifasciata",
...
//   if (loading) {
//     return (
//       <div className="py-8 px-4 sm:px-6 lg:px-8 bg-gray-50 min-h-screen flex items-center justify-center">
//         <div className="text-center">
//           <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-green-700 mx-auto"></div>
//           <p className="mt-4 text-gray-700">Loading plants...</p>
//         </div>
//       </div>
//     );
//   }
